...
public class M3u8Main {
    ...
    private static final String M3U8URL = "http://pull-l3.douyincdn.com/stage/stream-688319259056275538_ld.m3u8";

    public static void main(String[] args) {

        M3u8DownloadFactory.M3u8Download m3u8Download = M3u8DownloadFactory.getInstance(M3U8URL);
        //设置生成目录
        m3u8Download.setDir("/Users/deanzhang/work/code/km/m3u8Download/file");
        //设置视频名称
